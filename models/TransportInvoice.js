...
transportInvoiceSchema.pre('findOneAndUpdate', function(next) {
...
transportInvoiceSchema.methods.addPayment = async function(paymentData) {
  ...
  // Update transport invoice with new payment
...
module.exports = mongoose.model('TransportInvoice', transportInvoiceSchema);
